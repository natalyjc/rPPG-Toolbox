...
_C.INFERENCE.FEW_SHOT = CN()
_C.INFERENCE.FEW_SHOT.ENABLE = False
_C.INFERENCE.FEW_SHOT.SUPPORT_FRAMES = 540
_C.INFERENCE.FEW_SHOT.ADAPT_STEPS = 5
_C.INFERENCE.FEW_SHOT.LR = 1e-5
_C.INFERENCE.FEW_SHOT.WEIGHT_DECAY = 0.0
_C.INFERENCE.FEW_SHOT.WINDOW_FRAMES = 160
_C.INFERENCE.FEW_SHOT.NOISE = CN()
_C.INFERENCE.FEW_SHOT.NOISE.ENABLE = False
_C.INFERENCE.FEW_SHOT.NOISE.SUBJECT_IDS = []
_C.INFERENCE.FEW_SHOT.NOISE.STD = 0.0
_C.INFERENCE.FEW_SHOT.NOISE.SEED = 100
